...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'debtor', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.19971999.xyz', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://cdn.jsdelivr.net/gh/1-debtor/tuchuang/tuchuang/202404261347144.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'DEBTOR', // 站点描述，被notion中的页面描述覆盖DEBTOR
